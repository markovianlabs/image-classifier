...
def save_bottlebeck_features():
    ...
    np.save(open('../data/bottleneck_features_train.npy', 'w'), bottleneck_features_train)
    ...
    np.save(open('../data/bottleneck_features_validation.npy', 'w'), bottleneck_features_validation)
